...
const Home = ({ onAccessCamera, onAccessVerify }) => {
  return (
    <div className="w-screen min-h-screen bg-slate-50 font-sans text-slate-900 flex flex-col">
      ...
      {/* --- BODY / HERO SECTION --- */}
      <main className="h-screen flex items-center justify-center px-4 py-20 bg-[radial-gradient(circle_at_top_right,_var(--tw-gradient-stops))] from-indigo-50 via-white to-white">
        <div className="max-w-4xl text-center">
          ...
          <h1 className="text-5xl md:text-7xl font-extrabold text-slate-900 mb-6 tracking-tight">
            See what’s real.<br />
            <span className="text-indigo-600"> Prove what’s true. </span>
          </h1>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            ...
            <button 
              ...
              className="flex items-center gap-2 bg-white border-2 border-slate-200 hover:border-indigo-600 hover:text-indigo-600 text-slate-700 px-8 py-4 rounded-xl font-semibold text-lg transition-all shadow-sm"
            >
      ...
      <footer className="bg-slate-900 text-slate-400 py-12 px-4">
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-12 border-b border-slate-800 pb-12">
          ...
          <div className="col-span-1 md:col-span-1">
            ...
            <p className="text-sm leading-relaxed">
              Leading the industry in optical verification and smart security systems since 2025.
            </p>
          </div>
        ...
        <div className="max-w-7xl mx-auto pt-8 flex flex-col md:flex-row justify-between items-center gap-4 text-xs">
          <p>© 2025 True Lens by SURPRAN. All rights reserved.</p>
